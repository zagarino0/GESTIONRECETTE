...
function MontantNatureImpot() {
      // Navbar 
      const Navbarcontent = (
        <div className='flex justify-between '>
          <div className='text-white font-semibold '>
          Impression montant par nature impôt
         </div>
         <div>
           ...
           <div className="flex flex-col h-full p-4">
             <div ref={printRef} className="mb-8 w-[1700px] bg-white p-6">
               ...
               <div className="text-center">
                 <h2 className="font-bold text-2xl">GESTION DE LA CONSULTATION  NATURE D'IMPOT</h2>
               </div>
...
export default MontantNatureImpot