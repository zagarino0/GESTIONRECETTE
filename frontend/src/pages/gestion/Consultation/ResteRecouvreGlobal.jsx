...
const NavbarContent = (
    ...
    <Checkbox label="Par RF"></Checkbox>
     ...
     <div className='flex justify-between'>
       ...
       <Button type="submit" children="Imprimer Titre de Peception" onClick={ () => {window.location.href = "/TitrePerceptio"}} ></Button>
...
export default ResteRecouvreGlobal