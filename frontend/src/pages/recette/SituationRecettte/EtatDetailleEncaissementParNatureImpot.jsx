  ...
  const Navbarcontent = (
    <div className='flex justify-between '>
      <div className='text-white '>
       Etat detaillé des encaissements par nature d'impôts
      </div>
      <div>
    ...
    <div className='bg-[#212122] h-screen w-screen'>
      ...
      <div className="flex flex-col p-4">
        <div className='flex flex-row'>
          <SearchInput value={searchTerm} className={"mt-8"} placeholder={"Rechercher par nature impôt"} onChange={(e) => setSearchTerm(e.target.value)}></SearchInput>
...
export default EtatDetailleEncaissementParNatureImpot;
