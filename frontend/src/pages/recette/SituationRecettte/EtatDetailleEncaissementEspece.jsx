...
function EtatDetailleEncaissementEspece() {

  // Navbar
  const Navbarcontent = (
    <div className='flex justify-between '>
      <div className='text-white '>
       Etat detaillé des encaissements (Espèce)
      </div>
      <div>
    ...
    <div className='bg-[#212122] h-screen w-screen'>
      ...
      <div className="flex flex-col p-4">
        <div className='flex flex-row'>
          <SearchInput value={searchTerm} className={"mt-8"} placeholder={"Rechercher par référence fiscale"} onChange={(e) => setSearchTerm(e.target.value)}></SearchInput>
...
export default EtatDetailleEncaissementEspece;
