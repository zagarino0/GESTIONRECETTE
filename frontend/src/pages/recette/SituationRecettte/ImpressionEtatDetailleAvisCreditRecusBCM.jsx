...
function ImpressionEtatDetailleAvisCreditRecusBCM() {
      // Navbar 
      const Navbarcontent = (
        <div className='flex justify-between '>
          <div className='text-white font-semibold '>
          Impression état détaille avis credit reçus par BCM
         </div>
         <div>
 <BackButton to="/SituationRecette"></BackButton>
  ...
  const Choix = [
   ...
   {/**           <p>Code : {userCode}</p> {/* Code synchronisé * */}
          ...
          <h1 className="font-bold text-xl text-center">ÉTAT DÉTAILLÉ DES AVIS DE CRÉDIT RECUS PAR BCM</h1>
...
export default ImpressionEtatDetailleAvisCreditRecusBCM