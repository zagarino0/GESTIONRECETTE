...
function EtatDetailleEncaissementTresor() {
  
  // Navbar
  const Navbarcontent = (
    <div className='flex justify-between '>
      <div className='text-white '>
        Etat detaillé des encaissements (TRESOR)
      </div>
      <div>
  ...
  const handleSendImpression =() =>{
    const routeToNavigate = '/ImpressionTresor';
    navigate(routeToNavigate, { state: { searchTerm, startDate, endDate } });
    ...
    <div className='bg-[#212122] h-screen w-screen'>
      ...
      <div className="flex flex-col p-4">
        ...
        <div className="h-[400px] p-4">
          ...
          <div className='flex justify-between'>
            <Button children="voir details" onClick={handleSendImpression} className="mt-4"></Button>
...
export default EtatDetailleEncaissementTresor;
