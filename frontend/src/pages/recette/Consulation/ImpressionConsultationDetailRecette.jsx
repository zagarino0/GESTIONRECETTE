...
function ImpressionConsultationDetailRecette() {
      // Navbar 
      const Navbarcontent = (
        <div className='flex justify-between '>
          <div className='text-white font-semibold '>
          Impression consultation de recette
         </div>
         <div>
 ...
 const filteredData = recepisse.filter((item) => {
  ...
  <div className="text-center">
    <h2 className="font-bold text-2xl">CONSULTATION DE LA RECETTE</h2>
...
export default ImpressionConsultationDetailRecette