...
function EnregistrementDeclarartionRegisseur() {
    ...
    const [ setDataSelectdPriseEnCharge] = useState([]);
  ...
  <DateFormatConverter isoDate={item.date_creation}></DateFormatConverter> ,
   item.RIB
    ...
    const handleEnregistrementDecl = () => {
      ...
      "fokontany" : DataCodeFokontanySelect.libelle
        };
      
        console.log(ValueEnregistrementNonPeriodique)
        // Send the updated data to the backend
        axios.post('http://localhost:3500/recette/declarationnonperiodique', ValueEnregistrementNonPeriodique)
  ...
  <Input type="text" value={value.periode2}
   ...
   <Input type="text"  
    value={value.raison_social}
    onChange={(e)=>setValue({...value , raison_social : e.target.value})}
   ></Input>
    </div>
   <div className='flex justify-between'>
 ...
 <Input type="text" className="ml-2" value={value.reste_a_payer} onChange={(e)=>setValue({...value , reste_a_payer : e.target.value})}  ></Input>
   ...
   <Input type="text" value={value.activite} 
   ...
   <Input type="text"  value={value.commune }
   onChange={(e)=>setValue({...value , commune : e.target.value})}
   ></Input>
   </div>
    </div>
      <div className="p-2 flex justify-between">
   ...
   <Input type="text" value={value.adresse} onChange={(e)=>setValue({...value , adresse : e.target.value})} ></Input>
    </div>
      <div className='flex justify-between w-[500px]'>
