...
function ReleveRF() {
  const headers = ['NIF', 'Raison social', 'Nom commercial', 'Gest.'];
  const data = [
    ['none', 'none', 'none', 'none'],
...
<BackButton to="/immatriculation"></BackButton>
  ...
  return (
    <div  className='bg-[#212122] h-screen w-screen'>
      ...
      <div className='flex justify-between bg-black m-4 p-4'>
<div className='flex justify-between '>
<Label text="Du :"></Label>
...
<Input type="text" className="ml-4 h-10"></Input>
  ...
  <div className='flex flex-row'>
    ...
    <Button children="Executer la requête" className="ml-4 w-36 h-14 "></Button>
  </div>
